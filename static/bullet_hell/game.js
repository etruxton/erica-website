...
function preload() {
    this.load.image('player', '../static/bullet_hell/assets/images/player.png');
    this.load.image('boss', '../static/bullet_hell/assets/images/boss.png');
    this.load.image('bossBullet', '../static/bullet_hell/assets/images/bossBullet.png');
    this.load.image('bullet', '../static/bullet_hell/assets/images/bullet.png');
}
...
async function updateHSVValue(hsvIndex, newValue) {
    ...
    try {
        const response = await fetch('/bullet_hell/update_hsv_values', {  // New route
            method: 'POST',
            headers: {
...
async function getGameState() {
    const response = await fetch("/bullet_hell/game_state");
...
async function updateGameState() {
    const response = await fetch('/bullet_hell/update_game_state', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
async function sendFrameToServer() {
    ...
    setInterval(async () => {
        ...
        canvas.toBlob(async (blob) => {
            ...
            try {
                const response = await fetch('/bullet_hell/video_feed', {
                    method: 'POST',
